...
def main():
    ...
    cocos2d_x_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..'))
    cocos_root = os.path.abspath(os.path.join(cocos2d_x_root, ''))
    cxx_generator_root = os.path.abspath(os.path.join(cocos2d_x_root, 'tools/bindings-generator'))
    ...
    try:
        ...
        tolua_root = '%s/external/libfairygui/tolua' % cocos2d_x_root
        output_dir = current_dir

        cmd_args = {
                    'cocos2dx_libfairygui.ini' : ('libfairygui', 'lua_cocos2dx_libfairygui_auto'), \
                    }
        target = 'lua'
        ...
        shutil.rmtree(os.path.join(current_dir, 'api'))
